...
persistent_memory.store_message("Example message")
retrieved_messages = persistent_memory.retrieve_messages()
print("Retrieved Messages:", retrieved_messages)
...
# Close the persistent memory connection when done
